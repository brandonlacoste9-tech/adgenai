...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, creative, targetAudience, userId, features, prediction, error, error_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _a = _d.sent(), creative = _a.creative, targetAudience = _a.targetAudience, userId = _a.userId;
                ...
                features = extractMLFeatures(creative, targetAudience);
                return [4 /*yield*/, runMLPrediction(features, creative.platform)
            ...
            case 5:
                error_1 = _d.sent();
                console.error('🚨 ML Performance API error:', error_1);
...
function extractMLFeatures(creative, audience) {
    var description = creative.description || '';
    var textLength = Math.min(description.length / 200, 1);
    var wordCount = Math.min(description.split(' ').length / 30, 1);
    var hasUrgency = /\b(now|today|limited|hurry|urgent|asap)\b/i.test(description) ? 1 : 0;
    var hasCTA = /\b(buy|shop|get|download|sign up|learn more|start|try|click|order)\b/i.test(description) ? 1 : 0;
    var hasNumbers = /\d/.test(description) ? 1 : 0;
    var hasEmotional = /\b(amazing|incredible|love|perfect|best|awesome|exclusive|free|save)\b/i.test(description) ? 1 : 0;
    return [
        textLength,
        wordCount,
        hasUrgency,
        ...
        encodeAudienceSize((audience === null || audience === void 0 ? void 0 : audience.size) || 'medium'),
...
function runMLPrediction(features, platform) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            insights = generateAdvancedInsights(features, expectedCtr, expectedCpa, platform);
            recommendations = generateActionableRecommendations(features, baseScore, platform);
...
function generateAdvancedInsights(features, ctr, cpa, platform) {
    var insights = [];
...
function generateActionableRecommendations(features, score, platform) {
    var recommendations = [];
    if (score < 60) {
    ...
    switch (platform) {
        ...
        case 'tiktok':
            ...
            if (features[0] > 0.5)
                recommendations.push('Minimize text overlay - let visuals tell the story');
            break;
        case 'linkedin':
            recommendations.push('Include industry-specific benefits and ROI messaging');
            if (features[5] < 0.5)
                recommendations.push('Add more professional tone and credibility indicators');
            break;
        case 'facebook':
