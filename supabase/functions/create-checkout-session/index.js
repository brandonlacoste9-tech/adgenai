...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var stripe, _a, priceId, successUrl, cancelUrl, customerEmail, userId, session, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = _b.sent(), priceId = _a.priceId, successUrl = _a.successUrl, cancelUrl = _a.cancelUrl, customerEmail = _a.customerEmail, userId = _a.userId;
                if (!priceId) {
                    throw new Error('Price ID is required');
                }
                console.log('Creating checkout session for:', { priceId: priceId, userId: userId, customerEmail: customerEmail });
